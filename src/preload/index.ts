...
const api: PodcastArtistApi = {
  ...
  revealExportOutput: (input: ExportOutputInput) => ipcRenderer.invoke('audio:revealExportOutput', input),
  openExportOutput: (input: ExportOutputInput) => ipcRenderer.invoke('audio:openExportOutput', input),
